  ...
  Widget build(BuildContext context) {
    return Scaffold(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Obx(() => IconButton(
                              ...
                              Icon(Icons.check_box_rounded): Icon(Icons.check_box_outline_blank_outlined),
                              onPressed: () {
      ...
      floatingActionButton: FloatingActionButton.extended(
          ...
          label: GetX<CartContorller>(builder: (controller) {
            return Text(
